					...
					<div class="panel-area">
						...
						<div class="panel-content">
							<ul class="nav nav-list">
								...
								<li class="active"><a href="{{url('autofilter-range-of-cells')}}">Autofilter Range of Cells</a></li>
					...
					<div class="panel-area">
						<div class="panel-header">
							<div class="inner-panel">
								...
								<a href="{{url('autofilter-range-of-cells-excel')}}" class="btn btn-primary pull-right">
