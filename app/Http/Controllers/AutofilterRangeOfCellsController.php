...
class AutofilterRangeOfCellsController extends Controller
{
    public function autofilter_range_of_cells(){
		$data = ExcelExport::all();
		return view('autofilter-range-of-cells', compact('data'));
	}
	
    public function autofilter_range_of_cells_excel(){
		...
		//work sheet name
		$spreadsheet->getActiveSheet()->setTitle('Autofilter Range of Cells');	
		/*Default Font Set*/
		...
		$spreadsheet->getActiveSheet()->SetCellValue('A2', 'Autofilter Range of Cells');
		...
		/*AutoFilter*/
		$spreadsheet->getActiveSheet()->setAutoFilter('B4:F4');
